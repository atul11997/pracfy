                                ...
                                <td class="d-flex">
                                   ...
                                   <div class="dropdown ms-2">
                                    <a class="btn btn-primary dropdown-toggle" href="#" role="button" id="dropdownMenuLink" data-bs-toggle="dropdown" aria-expanded="false">
                                        {{ $page->status === 0 ? 'Active' : 'In Active'; }}
                                    </a>

                                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                        <li><a class="dropdown-item" href="{{ route('section.status.change', ['id' => $page->id, 'status' => 0]) }}">Active</a></li>
                                        <li><a class="dropdown-item" href="{{ route('section.status.change', ['id' => $page->id, 'status' => 1]) }}">In Active</a></li>
                                    </ul>
                                    </div>
                                </td>
                            </tr>
        ...
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('section.process') }}" enctype="multipart/form-data">
                        @csrf
