...
==================================-->
                            ...
                            <div class="working-time item">
                                ...
                                <ul class="w-hours">
                                    <li>{{ Str::substr($user->clinic_open_from, 0, -3) }} -
                                        {{ Str::substr($user->clinic_open_to, 0, -3) }} - <span>{{ $clinicOpenTime }}
                                    ...
                                    <div class="col-md-6">
                                        <div class="item">
                                            <div class="icon-box">
                                                <figure>
                                                    <a href="#">
                                                        <img src="{{ $rows->icon ?? $rows->image }}" alt="">
                                                    </a>
                                                </figure>
                                            </div>
                                            <h6>{{ $rows->title ?? '' }}</h6>
        ...
        <section class="testimonial-section"
            style="background: url({{ url('/') }}/frontend/theme8/images/testimonials/1.jpg);" id="{{ strtolower($pages['testimonial']->page_name ?? '') }}">
            <div class="container">
                <div class="section-title text-center">
                            ...
                            <div class="accordion-holder">
                                <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="false">
                                    ...
                                    <div class="panel panel-default">
                                        ...
                                        <div id="collapse{{ $rows->id }}" class="panel-collapse collapse" role="tabpanel"
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="about-widget">
                                <div class="footer-logo">
                                    <figure>
                                        <a href="index.html">
                                            <img src="{{ $user->clinic_logo??'' }}" alt="" width="100px" height="50px">
                                        </a>
                                    </figure>
                                </div>
                                ...
                                <ul class="location-link">
                                    <li class="item">
                                        ...
                                        <p>{{ $user->address }}, {{ $user->city }}, {{ $user->state }}, {{ $user->country??'' }}, {{ $user->pincode }}</p>
                                    </li>
                                    <li class="item">
