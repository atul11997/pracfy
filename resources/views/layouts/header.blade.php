        ...
        <div class="container-fluid">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item d-lg-none">
              <a class="nav-link d-block d-lg-none text-dark" data-bs-toggle="offcanvas" href="#mobileSidebar" role="button">
                <i class="bi bi-list"></i>
              </a>
            </li>
            ...
            @else
            <img src="{{ url('/').'/public/assets/img/dummy_clinic_images.jpg' }}">
            @endif
