            ...
            <div class="card-body">
                <div class="row" id="servicesGrid">
                    ...
                    @foreach ($services as $service)
                        ...
                        @else
                        <img src="{{ asset('assets/img/No_Image_Available.jpg') }}" class="card-img-top" alt="{{ $service->title }}"
                            style="height: 200px; object-fit: cover;">
                        @endif
                                    <div class="card-body">
                        ...
                        <div class="row p-2">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="file" id="image" name="image" class="form-control"
                                    accept="image/*" />
                                <img id="simage" width="50px">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="icon">Icon</label>
                                <input type="file" id="icon" name="icon" class="form-control" />
                                <img id="sicon" width="50px">
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="description">Description</label>
                ...
                success: function(response) {
                    if (response.status === 'success') {
                        ...
                        img.onerror = function() {
                            $('#simage').attr('src', "http://myapp.org:8080/pracfy/public/assets/img/No_Image_Available.jpg");
                        };
                        img.src = response.data.image;

                        var img = new Image();
                        img.onload = function() {
                            $('#sicon').attr('src', response.data.icon);
                        };
                        img.onerror = function() {
                            $('#sicon').attr('src', "http://myapp.org:8080/pracfy/public/assets/img/No_Image_Available.jpg");
                        };
                        img.src = response.data.icon;
