...
class SiteController extends Controller
{
    ...
    //     return response()->json(['status'=>'success', 'message'=>'Enquiry Added Successfully'], 200);
    // }
    public function get_theme_customization(){
        $user = User::where('id', Auth::user()->id)->first();
        return response()->json(['status'=>'success', 'message'=>'Website Theme Color Show Successfully', 'selected_theme'=>$user->selected_theme, 'theme_customization'=>$user->theme_customizations]);
    }
    ...
    public function privacyPolicy(){
        return view('user_frontend.privacy_policy');
    }

    public function termsServices(){
        return view('user_frontend.terms_of_services');
    }
}
